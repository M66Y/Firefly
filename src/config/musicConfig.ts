		...
		playlist: [
			{
				name: "光るなら (若能绽放光芒)",
				artist: "Goose house",
				url: "/assets/music/Goose house - 光るなら (若能绽放光芒).mp3",
				cover: "",
				lrc: "",
			},
			{
				name: "虹の彼方に (在彩虹的彼方)",
				artist: "ReoNa",
				url: "/assets/music/ReoNa - 虹の彼方に (在彩虹的彼方).mp3",
				cover: "",
				lrc: "",
			},
			{
			...
			},
			{
				...
				url: "/assets/music/茶理理理子、TetraCalyx、hanser - Moon Halo.mp3",
				cover: "",
				lrc: "",
			},
			{
